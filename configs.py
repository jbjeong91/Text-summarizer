...
tf.app.flags.DEFINE_integer('batch_size', 8, 'batch size')  # 배치 크기
tf.app.flags.DEFINE_integer('train_steps', 500, 'train steps')  # 학습 에포크
...
tf.app.flags.DEFINE_integer('attention_head_size', 2, 'attn head size')  # 멀티 헤드 크기
